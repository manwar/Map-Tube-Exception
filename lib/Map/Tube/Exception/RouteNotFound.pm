package Map::Tube::Exception::RouteNotFound;

=head1 NAME

Map::Tube::Exception::RouteNotFound - Represent 'route not found' exception.
...
has status => (is => 'ro', default => sub { 133 });
...
1; # End of Map::Tube::Exception::RouteNotFound
