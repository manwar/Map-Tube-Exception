package Map::Tube::Exception::InvalidBackgroundColor;

=head1 NAME

Map::Tube::Exception::InvalidBackgroundColor - Represent 'invalid background color' exception.
...
has status => (is => 'ro', default => sub { 130 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::InvalidBackgroundColor
...
1; # End of Map::Tube::Exception::InvalidBackgroundColor
