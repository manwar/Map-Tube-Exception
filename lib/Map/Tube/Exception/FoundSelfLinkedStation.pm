...
$Map::Tube::Exception::FoundSelfLinkedStation::VERSION   = '3.08';
...
has status => (is => 'ro', default => sub { 111 });
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Exception::FoundSelfLinkedStation
...
1; # End of Map::Tube::Exception::FoundSelfLinkedStation
